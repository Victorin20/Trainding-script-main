...
def buyLimitStart(position, volume, combination_number):
    order_type = mt5.ORDER_TYPE_BUY_LIMIT       # Replace with the desired volume/lot size
    price = startPrice + position * points     # Set the price for the Buy Limit order
...
#combination 1
buyLimitStart(0, volume_1, 1)
#combination 2
buyLimitStart(0, volume_2, 2)
#combination 3
buyLimitStart(0, volume_3, 3)
#combination 4
buyLimitStart(0, volume_4, 4)
#combination 5
buyLimitStart(0, volume_5, 5)
#combination 6
buyLimitStart(0, volume_6, 6)
#combination 7 
buyLimitStart(0, volume_7, 7)
#combination 8
buyLimitStart(0, volume_8, 8)
#combination 9
buyLimitStart(0, volume_9, 9)
#combination 10
buyLimitStart(0, volume_10, 10)
#combination 11
buyLimitStart(0, volume_11, 11)
    ...
    if(failed_7 == False):
        ...
        if(failed_7 == False):
            ...
            if(last_price <= round(startPrice + points,5) and fifth_7 == False and fourd_active_7):
                blackbuyLimit(0, black_volume_7, points*1, points*4, 7)
                fifth_7 = True
        else :
