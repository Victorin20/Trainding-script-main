    ...
    if(failed_1 == False):
        ...
        if(failed_1 == False):
            ...
            if(last_price >= round(startPrice + points, 5) and third_1 == False and second_active_1):    
                blackbuyLimit(0, black_volume_1, points*1, points*8, 1)
                third_1 = True
        else :
