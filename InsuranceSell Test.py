    ...
    if(failed_1 == False):
        ...
        if(failed_1 == False):
            ...
            if(last_price <= round(startPrice - points * 2,5) and sixth_1 == False and fifth_active_1):
                blackSellLimit(-1, black_volume_sellLimit_1, blackSellLimit_stopLoss_1,  blackSellLimit_takeProfit_1, 1)
                sixth_1 = True
    ...
    if(failed_2 == False):
        ...
        if(failed_2 == False):
            ...
            if(last_price <= round(startPrice - points*2,5) and fourd_2 == False and third_active_2):
                blackbuyStop(1, black_volume_buyStop_2, blackbuyStop_stopLoss_2, blackbuyStop_takeProfit_2, 2)
                fourd_2 = True
            
            if(last_price >= round(startPrice - points,5) and fifth_2 == False and fourd_active_2):
                blackSellLimit(-1, black_volume_sellLimit_2, blackSellLimit_stopLoss_2, blackSellLimit_takeProfit_2, 2)
                fifth_2 = True
        else :
