...
blackSellStop_takeProfit = 75
blackSellStop_stopLoss = 50
one_lot = 10


path = "C:/Users/Public/insurance_Buy3.txt"
...
while failed == False and succes == False:
    ...
    if(failed == False):
        ...
        if(last_price >= startPrice + points*3 and fifth == False and fourd_active):
            blackSellStop(2, (volume*16 * 25* one_lot / (blackSellStop_stopLoss * one_lot)))
            fifth = True
